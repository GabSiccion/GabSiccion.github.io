...
})({"asYKt":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d6e71ce04de0074d";
"use strict";
...
},{}],"7VlIO":[function(require,module,exports) {
var _app = require("firebase/app");
var _database = require("firebase/database");
var _firebaseconfig = require("./firebaseconfig");
var _components = require("./components");
//Adds the navigation bar
customElements.define("main-header", (0, _components.Header));
...
const coursesRef = (0, _database.ref)(db, "courses/");
const selectedcourse = getSelectedCourse();
var data;
(0, _database.onValue)(coursesRef, (snapshot)=>{
    //JSON DATA
    ...
    for(let element in data){
        ...
        a.href = "exploration.html?course=" + data[element]["header-text"].replace(/\s+/g, "-");
    ...
    for(obj in data[selectedcourse]["tracks"]){
        ...
        for(obj2 in data[selectedcourse]["tracks"][obj]["track-topics"]){
            ...
            cardtext.innerHTML = data[selectedcourse]["tracks"][obj]["track-topics"][obj2]["topic-text"];
            let cardlink = document.createElement("a");
            cardlink.role = "button";
            if (!isEmpty(data[selectedcourse]["tracks"][obj]["track-topics"][obj2]["topic-ppt"])) {
                cardlink.className = "btn btn-success";
                cardlink.href = data[selectedcourse]["tracks"][obj]["track-topics"][obj2]["topic-ppt"];
...
},{"firebase/app":"5wGMN","firebase/database":"bpqHw","./firebaseconfig":"2ceaC","./components":"4xsbx"}]},["asYKt","7VlIO"], "7VlIO", "parcelRequire9b7c")

//# sourceMappingURL=exploration.4de0074d.js.map
